            ...
            table.getColumnModel().getColumn(i).setCellRenderer(new DefaultTableCellRenderer() {
                ...
                public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected,
                    ...
                    grid.getConstraints().stream()
                        ...
                        .filter(blockConstraint -> row >= blockConstraint.getBlock().line() && row < blockConstraint.getBlock().line2() && column >= blockConstraint.getBlock().column() && column < blockConstraint.getBlock().column2())
                        .findFirst()
                    ...
                    grid.getConstraints().stream()
                        ...
                        .filter(generalSymbolConstraint -> Arrays.stream(generalSymbolConstraint.getPositionList()).anyMatch(pos -> pos.getLine() == column && pos.getColumn() == row))
                        .findFirst()
                        .ifPresent(blockConstraint -> c.setBackground(new Color((grid.getConstraints().indexOf(blockConstraint) * 1234567) % 0x888888 + 0x777777)));
