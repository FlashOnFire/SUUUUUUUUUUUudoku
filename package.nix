{
  ...
  self = stdenv.mkDerivation (finalAttrs: {
    ...
    installPhase = ''
      ...
      cp build/libs/imGUI-1.0.jar $out/share/suuuuuuuuuudoku
      cp build/libs/swing-1.0.jar $out/share/suuuuuuuuuudoku
      cp build/libs/tui-1.0.jar $out/share/suuuuuuuuuudoku

      makeWrapper ${jdk}/bin/java $out/bin/imGUI \
        --prefix LD_LIBRARY_PATH : ${lib.makeLibraryPath [libGL]} \
        --add-flags "-jar $out/share/suuuuuuuuuudoku/imGUI-1.0.jar"

      makeWrapper ${jdk}/bin/java $out/bin/swing \
        --add-flags "-jar $out/share/suuuuuuuuuudoku/swing-1.0.jar"

      makeWrapper ${jdk}/bin/java $out/bin/tui \
        --add-flags "-jar $out/share/suuuuuuuuuudoku/tui-1.0.jar"
    '';
